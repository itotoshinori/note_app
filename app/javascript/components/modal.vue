    ...
    <div class="modal-mask">
      <div class="modal-wrapper">
        <div class="modal-container">
          <div>
            本文：<span class="font" v-if="formObject.description.length > 100"
              >{{ formObject.description.length }}文字</span
            ><span class="font">{{ formObject.errorMessage1 }}</span
            ><br />
            <textarea
              class="text_area"
              name="description"
          ...
          <div>
            リンク：<span class="font" v-if="formObject.errorMessage2">
              {{ formObject.errorMessage2 }}</span
            ><br />
            <input
              class="input"
              type="text"
          ...
          <br />
          <button @click="update" class="button_color_blue">OK</button>
...
export default {
  ...
  methods: {
    update() {
      ...
      if (
        this.formObject.description.length > 130 ||
